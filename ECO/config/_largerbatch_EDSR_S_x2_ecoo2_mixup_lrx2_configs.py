...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        # misc
        self.config_name = "largerbatch_EDSR_S_x2_ecoo2_mixup_lrx2"
        self.mixup_shift=0
        self.num_workers = 32
        ...
        self.train_path_imageHR = [
            utils.constant.PREPROCESSED_DATASET_HR_DIV2Ktrain_EDSR_S_x2,
        ]
        self.train_path_imageLR = [
            utils.constant.PREPROCESSED_DATASET_LRBICx2_DIV2Ktrain_EDSR_S_x2,
        ]
