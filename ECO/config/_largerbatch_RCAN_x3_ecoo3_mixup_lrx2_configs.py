...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        # misc
        self.config_name = "largerbatch_RCAN_x3_ecoo3_mixup_lrx2"
        self.mixup_shift = 0
        
        
        # model
        self.generator = "RCAN@RCAN_x3"
        ...
        self.train_path_imageHR = [
            utils.constant.PREPROCESSED_DATASET_HR_DIV2Ktrain_RCAN_x3,
        ]
        self.train_path_imageLR = [
            utils.constant.PREPROCESSED_DATASET_LRBICx3_DIV2Ktrain_RCAN_x3,
        ]
